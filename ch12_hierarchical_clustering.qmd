...
By default, it will try number of clusters from 1 to 10. You can change the range of the number of clusters as the same to supervised learning, by using a parameter set object.
...
Or, you can create an explicit grid of hyperparameter values that you want to try.
...
Let us see the cross-validated average silhouette by the number of clusters.
